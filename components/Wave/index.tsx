  ...
  return (
    <div className={cn(footer.content)}>
      <div className={cn(footer.wave, 'animate-bounce-2s')}>
        <First className={cn('bottom-0', footer.wave_flip)} width="100%" height="100%" />
      </div>
      <div className={cn(footer.wave, 'animate-bounce-1.5s')}>
        <Second className={cn('bottom-0', footer.wave_flip)} width="100%" height="100%" />
      </div>
      <div className={cn(footer.wave, 'animate-bounce-1s')}>
        <Third className={cn('bottom-0', footer.wave_flip)} width="100%" height="100%" />
      </div>
    </div>
  );
}
